...
function VerificationBadges({ verified, certified }: { verified?: boolean; certified?: boolean }) {
  ...
  return <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginTop: 5 }}>
    {verified && <Text style={{ color: colors.brand, fontWeight: '900' }}>✓ Verificado</Text>}
    {certified && <Text style={{ color: colors.brand, fontWeight: '900' }}>✓ Titulado</Text>}
  </View>
}
