...
export interface ServiceEvidence { id: string; uploadedByName: string; evidenceType: EvidenceType; fileUrl: string; description?: string }
export interface PaymentProof { id: string; amount: number; paymentMethod: ProofMethod; status: 'PENDING_REVIEW' | 'APPROVED' | 'REJECTED'; fileUrl: string; reviewComment?: string }
