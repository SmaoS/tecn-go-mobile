...
export const paymentsApi = {
  ...
  rechargeTechnicianWallet: (amount: number) => api.post<RechargeResponse>('/v1/technicians/me/wallet/recharge', { amount, platform: 'MOBILE' }).then(({ data }) => data),
  reconcileTechnicianRecharge: (transactionId: string) =>
