...
export function LegalScreen() {
  ...
  return <KeyboardAwareScreen><QueryState pending={documents.isPending} error={documents.error}><Text style={styles.title}>Seguridad y términos</Text><Text style={styles.subtitle}>Borrador sujeto a revisión jurídica.</Text>
